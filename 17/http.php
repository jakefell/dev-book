 ...
 * Time: 21:12
 */
    // If we were using IIS, we need to set
    ...
    if (($_SERVER['PHP_AUTH_USER'] != 'user') ||
        ...
        // visitor has not yet given details, or there name and password
        // combination are not correct
        ...
        // visitor has provided corrected details
        echo '
        <h1>Here it is!</h1>
